...
export default function Projects() {
  ...
  const sudoku = {
    ...
    name: "Sudoku",
    description:
      "Sudoku SPA made in React. Accessible for wider screens, interactive interface, keyboard support, game state management, different styles depending on the user's preference. Made with React and nodeJs",
  ...
  const sudokuMobile = {
    ...
    name: "Sudoku Mobile",
    description:
      "Sudoku SPA made in react. Accessible for smaller screens, interactive interface with number selection buttons for touch screens, game state management, different styles depending on the user's preference. Made with React and nodeJs",
    url: "https://sudoku-prueba.vercel.app",
    repositorio: "https://github.com/Orianamartina/sudoku-prueba",
  };
  const dogHub = {
    ...
    name: "DogHub",
    description:
      "Dog breed searching SPA. Responsive. Search your favorite breeds, sort them or filter them by the given options, find all their information, or create a new one. Made with React and nodeJs",
