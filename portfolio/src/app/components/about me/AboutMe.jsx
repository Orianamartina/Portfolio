...
export default function AboutMe(){
    ...
    return(
        <div>
            ...
            <p>
                I lived for a year in Denmark, in the city of Copenhagen and the beautiful island of Bornholm, and also lived for 4 months in Stockholm, where I shared accommodation and experiences with people from various European countries, 
